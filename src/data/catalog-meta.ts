export const CATALOG = {
  ...
  publisher: { name: "Aletheia", role: "Publisher and product vendor", disclosure: "Aletheia publishes Agent Security Index. The launch product directory contains external products only." },
